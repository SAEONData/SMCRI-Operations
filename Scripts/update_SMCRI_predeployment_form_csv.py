...
sites_csv_AO.download(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files')
...
sites_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\sites.csv'
...
combined_sites.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\sites.csv', index=False)
...
utr_service.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\utr_service_groups.csv', index=False)
utr_service_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\utr_service_groups.csv'
...
utr_deployment.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\utr_deployments.csv', index=False)
utr_deployment_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\utr_deployments.csv'
# update in ArcGIS Online
...
utr_details.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\utr_details.csv', index=False)
utr_details_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\utr_details.csv'
...
gtp_service.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\gtp_service_groups.csv', index=False)
gtp_service_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\gtp_service_groups.csv'
# update in ArcGIS Online
...
gtp_deployment.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\gtp_deployments.csv', index=False)
gtp_deployment_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\gtp_deployments.csv'
# update in ArcGIS Online
...
gtp_details.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\gtp_details.csv', index=False)
gtp_details_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\gtp_details.csv'
# update in ArcGIS Online
...
# #Create UTR deployments file and update in arcgis online
adcp_deployment_AO = gis.content.search('d7534ae118114fe5b06f49ef06f439d7', item_type="CSV")[0]
adcp_deployment_AO.download(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files')
adcp_deployment_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\adcp_deployments.csv'
...
adcp_deployment.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\adcp_deployments.csv', index=False)
adcp_deployment_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\adcp_deployments.csv'
# update in ArcGIS Online
...
adcp_details.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\adcp_details.csv', index=False)
adcp_details_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\adcp_details.csv'
# update in ArcGIS Online
...
ct_service.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\ct_service_groups.csv', index=False)
ct_service_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\ct_service_groups.csv'
# update in ArcGIS Online
...
ct_deployment.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\ct_deployments.csv', index=False)
ct_deployment_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\ct_deployments.csv'
# update in ArcGIS Online
...
ct_details.to_csv(r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\ct_details.csv', index=False)
ct_details_csv_temp = r'C:\Scheduled_Python_Scripts\SMCRI_OIMS\SMCRI-Operations\csv_files\ct_details.csv'
# update in ArcGIS Online
